...
class Progressive8_Recons(nn.Module):
    def __init__(self, in_channels, out_channels, num_channels=16):
        super().__init__()
        self.in_conv = nn.Conv2d(in_channels, num_channels, kernel_size=3, stride=1, padding='same')
        ...
        self.decoder1 = DecoderBlock(num_channels*16+128, out_channels, kernel_size=3, stride=1, padding='same')
        self.decoder2 = DecoderBlock(out_channels+64, out_channels, kernel_size=3, stride=1, padding='same')
        self.decoder3 = DecoderBlock(out_channels+32, out_channels, kernel_size=3, stride=1, padding='same')
        self.decoder4 = DecoderBlock(out_channels+16, out_channels, kernel_size=3, stride=1, padding='same')
...
class Progressive7_Recons(nn.Module):
    def __init__(self, in_channels, out_channels, num_channels=16):
        super().__init__()
        self.in_conv = nn.Conv2d(in_channels, num_channels, kernel_size=3, stride=1, padding='same')
...
class Progressive6_Recons(nn.Module):
    def __init__(self, in_channels, out_channels, num_channels=16):
        super().__init__()
        self.in_conv = nn.Conv2d(in_channels, num_channels, kernel_size=3, stride=1, padding='same')
...
class Progressive5_Recons(nn.Module):
    def __init__(self, in_channels, out_channels, num_channels=16):
        super().__init__()
        self.in_conv = nn.Conv2d(in_channels, num_channels, kernel_size=3, stride=1, padding='same')
...
class Progressive4_Recons(nn.Module):
    def __init__(self, in_channels, out_channels, num_channels=16):
        super().__init__()
        self.in_conv = nn.Conv2d(in_channels, num_channels, kernel_size=3, stride=1, padding='same')
...
class Progressive3_Recons(nn.Module):
    def __init__(self, in_channels, out_channels, num_channels=16):
        super().__init__()
        self.in_conv = nn.Conv2d(in_channels, num_channels, kernel_size=3, stride=1, padding='same')
...
class Progressive2_Recons(nn.Module):
    def __init__(self, in_channels, out_channels, num_channels=16):
        super().__init__()
        self.in_conv = nn.Conv2d(in_channels, num_channels, kernel_size=3, stride=1, padding='same')
