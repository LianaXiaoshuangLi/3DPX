...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--loadSize', type=int, default=256, help='scale images to this size') # default 1024
        self.parser.add_argument('--fineSize', type=int, default=512, help='then crop to this size')
        self.parser.add_argument('--label_nc', type=int, default=1, help='# of input label channels') # 35
        self.parser.add_argument('--input_nc', type=int, default=150, help='# of input image channels') # 3
        self.parser.add_argument('--output_nc', type=int, default=150, help='# of output image channels') # 3
